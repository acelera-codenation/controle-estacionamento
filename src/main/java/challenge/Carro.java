...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            ...
            if (placa.trim().isEmpty()) throw new NullPointerException(Mensagem.PLACA_NAO_INFORMADA);
            if (cor == null) throw new NullPointerException(Mensagem.COR_NAO_INFORMADA);

            if (motorista == null)
                throw new EstacionamentoException(Mensagem.CARRO_AUTONOMO_NAO_PERMITIDO);
